...
{
cat <<'HTML'
<!DOCTYPE html><html lang="en" data-theme="desert"><head><meta charset="utf-8"><meta name="viewport" id="catalogViewport" content="width=device-width, initial-scale=1, viewport-fit=cover"><title>DecentSampler Library Catalog</title>
<style>
